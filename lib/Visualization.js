...
class Visualization {
  ...
  search(str) {
    ...
    console.log('currentSearchTerm: ', this.currentSearchTerm);
    Animations.search.call(this);
  }
  ...
  clearSearch() {
    ...
    this.currentSearchTerm = '';
    console.log('currentSearchTerm: ', this.currentSearchTerm);    
    Animations.reset.call(this);
    // restore camera angles, release cubes
  }
